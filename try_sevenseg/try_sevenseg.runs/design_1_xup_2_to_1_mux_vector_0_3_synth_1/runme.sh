...
HD_PWD='C:/Users/hatic/try_sevenseg/try_sevenseg.runs/design_1_xup_2_to_1_mux_vector_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xup_2_to_1_mux_vector_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xup_2_to_1_mux_vector_0_3.tcl
