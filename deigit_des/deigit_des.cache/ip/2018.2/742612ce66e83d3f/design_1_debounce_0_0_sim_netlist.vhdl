...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_debounce is
  ...
  signal q_next0 : STD_LOGIC_VECTOR ( 19 downto 1 );
  ...
  signal \NLW_q_next0_carry__3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_q_next0_carry__3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \q_reg[10]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \q_reg[11]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \q_reg[12]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \q_reg[13]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \q_reg[14]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \q_reg[15]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \q_reg[16]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \q_reg[17]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \q_reg[18]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \q_reg[19]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \q_reg[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \q_reg[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \q_reg[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \q_reg[4]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \q_reg[5]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \q_reg[6]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \q_reg[7]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \q_reg[8]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \q_reg[9]_i_1\ : label is "soft_lutpair6";
begin
  o <= \^o\;
...
\q_next0_carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 2) => \NLW_q_next0_carry__3_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \q_next0_carry__3_n_2\,
      CO(0) => \q_next0_carry__3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_q_next0_carry__3_O_UNCONNECTED\(3),
      O(2 downto 0) => q_next0(19 downto 17),
      S(3) => '0',
      S(2 downto 0) => q_reg(19 downto 17)
    );
...
\q_reg[19]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"82"
    )
        port map (
