...
HD_PWD='C:/Users/hatic/deigit_des/deigit_des.runs/design_1_xlslice_0_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xlslice_0_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xlslice_0_5.tcl
