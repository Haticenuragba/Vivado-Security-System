...
HD_PWD='C:/Users/hatic/deigit_des/deigit_des.runs/design_1_xup_2_to_1_mux_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xup_2_to_1_mux_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xup_2_to_1_mux_0_0.tcl
